...
public class Deck {
    private final ArrayList<Card> cardsPartOfDeck = new ArrayList<>();
    private final ArrayList<Card> cardsLeftInDeck = new ArrayList<>();

    public Deck() {
        for (Value v : Value.values()) {
            for (Suits s : Suits.values()) {
                this.cardsPartOfDeck.add(new Card(s, v));
            }
        }
        this.cardsLeftInDeck.addAll(this.cardsPartOfDeck);
    }

    /**
     * @return All the {@code Cards} this {@code Deck} should have when full
     */
    public ArrayList<Card> getCardsPartOfDeck() {
        return cardsPartOfDeck;
    }
    ...
    public void printDeck() {
        cardsPartOfDeck.forEach((c) -> System.out.println(c.toString()));
    }
    ...
    public void reshuffle() {
        cardsLeftInDeck.addAll(cardsPartOfDeck);
        this.shuffle();
    }
